...
import modifiedArea from "@/vues/functionArea/areaType5.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import modifiedJSON from "@/vues/json/modified-dashboard.json";
