...
import contractArea from "@/vues/functionArea/areaType1.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import contractJSON from "@/vues/json/sign-contract-contract-approved.json";
