<template>
  <div class="space-y-10 xl:space-y-20 md:w-1/2">
    ...
    <div class="grid justify-items-center lg:justify-items-center">
      <classic-small-item :title="'檢舉不實評價'"></classic-small-item>
    </div>
  </div>
</template>
...
import warningArea from "@/vues/functionArea/areaType6.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import warningJSON from "@/vues/json/warning-animation.json";
