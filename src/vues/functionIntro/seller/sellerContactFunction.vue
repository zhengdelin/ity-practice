...
import sellerContactingArea from "@/vues/functionArea/areaType7.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import communicationJSON from "@/vues/json/communication.json";
