...
import reservationArea from "@/vues/functionArea/areaType6.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import orderFoodJSON from "@/vues/json/order-food.json";
