...
import couponFlyArea from "@/vues/functionArea/areaType2.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import couponFlyJSON from "@/vues/json/coupon-fly.json";
