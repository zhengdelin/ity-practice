...
import advertisingArea from "@/vues/functionArea/areaType3.vue";
import classicSmallItem from "@/vues/classic/classicSmallItem.vue";
import advertisingJSON from "@/vues/json/social-media-marketing.json";
