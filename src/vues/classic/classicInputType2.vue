<!--Use:loginPage, signUpPage, sellerAddPost, cards/consumerAccountInfoCard, cards/consumerAccountPhoneCard-->
<template>
...
export default {
  props: {
    classicInputType2: { type: Object, default: () => ({}) },
  },
};
</script>
